...
{   
    ...
    public class RoleController : Controller
    {
        ...
        public RoleController(AppIdentityDbContext context,RoleManager<IdentityRole> roleMgr, UserManager<AppUser> userMrg)
        {
            _context = context;
            roleManager = roleMgr;
            userManager = userMrg;
        ...
        [HttpPost]
        public async Task<IActionResult> Remove(RoleModification model)
        {
        ...
        [Authorize(Roles = "Administrador, Advogado, Usuario")]
